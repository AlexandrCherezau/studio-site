...
// Ported from react-bits.dev Components/LineSidebar (TS-TW).
// Ponytail: dropped a few props we don't tune (scaleTick) — kept
// the rest verbatim because the prop matrix IS the visual.
...
export function LineSidebar({
  ...
  // Single rAF loop that eases every item's --effect toward its
  // target using frame-rate-independent exponential smoothing so
  // color, shift and scale all move together without staggering
  // CSS transitions. Verbatim from the upstream port.
